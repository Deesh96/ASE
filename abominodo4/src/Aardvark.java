...
public class Aardvark {
    ...
    AardvarkDomino as = new AardvarkDomino();
    ...
    public void play(){
        ...
        switch (c2) {
            case 1:
                as.generateDominoes(this);
                as.shuffleDominoesOrder(this);
                as.placeDominoes(this);
                as.collateGrid(this);
                break;
            case 2:
                as.generateDominoes(this);
            ...
            default:
                ...
                as.rotateDominoes(this);
                as.rotateDominoes(this);
                as.invertSomeDominoes(this);
                as.collateGrid(this);
                break;
        }
        as.printGridorGuess(grid);
        as.generateGuesses(this);
        as.collateGuessGrid(this);
        mode = 1;
        cf = 0;
        score = 0;
        ...
        while (c3 != ZERO) {
            ...
            System.out.println("What do you want to do " + getPlayerName() + "?");
            c3 = 9;
            ...
            switch (c3) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    as.printGridorGuess(gg);
                    break;
                case 3:
                    Collections.sort(_g);
                    as.printGuesses(this);
                    break;
                case 4:
                    System.out.println("Where will the top left of the domino be?");
                    System.out.println("Column?");

                    // something should be updated here
                    break;
                case 5:
                ...
                case 6:
                    ...
                    switch (yy) {
                        case 0:
                            switch (cf) {
                                ...
                                case 1:
                                    ...
                                    setPlayerName(getPlayerName() + "(scoundrel)");
                                    cf++;
                                    break;
                                default:
                                    System.out.println("Some people just don't learn");
                                    setPlayerName(getPlayerName().replace("scoundrel", "pathetic scoundrel"));
                        ...
                        case 1:
                            ...
                            Domino dd = as.findByLH(this, x5, x4, _d);
                        ...
                        case 2:
                            ...
                            x3--;
                            y3--;
                            Domino lkj2 = as.findAt(this, x3, y3, _d);
        ...
        as.recordTheScore(this);
        System.out.println("Here is the solution:");
        System.out.println();
        Collections.sort(_d);
        as.printDominoes(this);
    ...
    public void run() {
        ...
        setPlayerName(IOLibrary.getString());
        ...
        while (variableNumber != ZERO) {
            ...
            variableNumber = -9;
            while (variableNumber == -9) {
                try {
                    String s1 = IOLibrary.getString();
                    variableNumber = Integer.parseInt(s1);
                } catch (Exception e) {
                    variableNumber = -9;
                }
            }
